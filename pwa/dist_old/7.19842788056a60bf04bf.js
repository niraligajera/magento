...
h=h.concat(n.default.createElement("li",{key:y,className:g},n.default.cloneElement(this.props.customPaging(y),{onClick:O})))}return n.default.cloneElement(this.props.appendDots(h),function _objectSpread(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{}
...
t.swipeMove=function swipeMove(e,t){var r=t.scrolling,n=t.animating,o=t.vertical,a=t.swipeToSlide,s=t.verticalSwiping,l=t.rtl,c=t.currentSlide,u=t.edgeFriction,d=t.edgeDragged,h=t.onEdge,y=t.swiped,v=t.swiping,b=t.slideCount,S=t.slidesToScroll,w=t.infinite,O=t.touchObject,m=t.swipeEvent,P=t.listHeight,k=t.listWidth
...
var R=Math.ceil(b/S),E=p(t.touchObject,s),I=O.swipeLength
return w||(0===c&&("right"===E||"down"===E)||c+1>=R&&("left"===E||"up"===E)||!f(t)&&("left"===E||"up"===E))&&(I=O.swipeLength*u,!1===d&&h&&(h(E),T.edgeDragged=!0)),!y&&m&&(m(E),T.swiped=!0),j=o?C+I*(P/k)*x:l?C-I*x:C+I*x,s&&(j=C+I*x),T=_objectSpread(_objectSpread({},T),{},{touchObject:O,swipeLeft:j,trackStyle:_(_objectSpread(_objectSpread({},t),{},{left:j}))}),Math.abs(O.curX-O.startX)<.8*Math.abs(O.curY-O.startY)?T:(O.swipeLength>10&&(T.swiping=!0,i(e)),T)}}
...
m.trackStyle=S(_objectSpread(_objectSpread({},t),{},{left:T}))}return m}
