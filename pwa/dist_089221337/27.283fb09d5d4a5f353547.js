 ...
 * 
 */
(window.webpackJsonp=window.webpackJsonp||[]).push([[27],{"+nJi":function(e,t,r){var n=r("HnfQ"),i=r("yPRz"),o=i.each,a=i.isFunction,s=i.isArray
...
t.default=S}.call(this,r("yLpj"))},M4TR:function(e,t,r){"use strict"
...
var R=Math.round(Math.sqrt(Math.pow(w.curY-w.startY,2)))
if(!s&&!v&&R>10)return{scrolling:!0}
s&&(w.swipeLength=R)
var z=(l?-1:1)*(w.curX>w.startX?1:-1)
s&&(z=w.curY>w.startY?1:-1)
var x=Math.ceil(b/g),E=p(t.touchObject,s),L=w.swipeLength
return m||(0===c&&("right"===E||"down"===E)||c+1>=x&&("left"===E||"up"===E)||!f(t)&&("left"===E||"up"===E))&&(L=w.swipeLength*u,!1===d&&h&&(h(E),T.edgeDragged=!0)),!y&&O&&(O(E),T.swiped=!0),j=o?C+L*(P/k)*z:l?C-L*z:C+L*z,s&&(j=C+L*z),T=_objectSpread(_objectSpread({},T),{},{touchObject:w,swipeLeft:j,trackStyle:_(_objectSpread(_objectSpread({},t),{},{left:j}))}),Math.abs(w.curX-w.startX)<.8*Math.abs(w.curY-w.startY)?T:(w.swipeLength>10&&(T.swiping=!0,i(e)),T)}}
...
i(e),f&&f(w)
var j=_?b:h
switch(w){case"left":case"up":k=j+v(t),P=u?y(t,k):k,O.currentDirection=0
break
